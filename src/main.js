/**
 * Main workflow for water classification using Google Earth Engine.
 */

var Query = require('./modules/DataQuery');
var CloudMask = require('./modules/CloudMask');
var PCA = require('./modules/PCA');
var GLCM = require('./modules/GLCM');
